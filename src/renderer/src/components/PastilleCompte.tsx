...
export default function PastilleCompte() {
  ...
  return (
    ...
    <div
      title={libelle}
      className="relative mt-auto mb-6 flex h-10 w-10 shrink-0 items-center justify-center rounded-[10px] border border-ink-700 bg-ink-800 font-data text-[15px] text-muted"
    >
